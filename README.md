...
- The arena is an enclosed venue: a closed ceiling 16 units up, a truss rig
  ...
  on the first beat, independently of the ambient lighting fade. Flashing
  lasers and beams use only the hit and its decay, excluding the ambient
  pre-beat lift so it cannot trigger a brief extra flash before an off bar.
